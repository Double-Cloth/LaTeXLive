...
document.writeln("      <a href='./index.html'><h1 class='navbar-brand'>LaTeX公式编辑器<span id='ver_h1'></span></h1></a>");
...
document.writeln("            <a class='nav-link' href='./index.html' id='btn_home'>编辑器</a>");
document.writeln("          </li>");
document.writeln("          <li class='nav-item'>");
document.writeln("            <a class='nav-link' href='./readme.html' id='btn_help'>帮助文档</a>");
document.writeln("          </li>");
document.writeln("          <li class='nav-item'>");
document.writeln("            <a class='nav-link' href='./update.html' id='btn_update'>更新日志</a>");
document.writeln("          </li>");
document.writeln("          <!--<li class='nav-item'>");
document.writeln("            <a class='nav-link' href='./messageboard.html'  id='btn_messageboard'>留言板</a>");
document.writeln("          </li>-->");
document.writeln("        </ul>");
document.writeln("        <ul class='navbar-nav ml-auto'>");
document.writeln("          <li class='nav-item' id='wrap_btn_href_login'>");
document.writeln("            <a class='nav-link' href='./login.html' id='btn_href_login'>登录/注册</a>");
document.writeln("          </li>");
document.writeln("          <li class='nav-item dropdown' id='wrap_btn_href_personal'>");
document.writeln("            <a class='nav-link dropdown-toggle' href='./personal.html' id='a-login-ed' data-toggle='dropdown'>");
document.writeln("              <img src='' id='img-nav-portrait' /><span id='span-nav-portrait'>个人中心</span>");
document.writeln("            </a>");
document.writeln("            <div class='dropdown-menu'>");
document.writeln("              <a class='dropdown-item' href='./personal.html'>个人中心</a>");
document.writeln("              <hr>");
